...
//Planets:
const NEW_BORN_PLANET = new NewBornPlanet(0.01, new THREE.Vector3(62, 0, 0), 0.5, SUN, 185000, !(SUN.getSpinsClockwise()));
...
const DYING_PLANET = new DyingPlanet(0.01, new THREE.Vector3(124, 0, 0), 0.56, SUN, 36500, !(SUN.getSpinsClockwise()));
